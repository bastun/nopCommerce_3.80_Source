...
namespace Nop.Plugin.Admin.Orange.Services
{
    /// <summary>
    /// Store pickup point service
    /// </summary>
    public partial class AdminOrangeService : IAdminOrangeService
    {
        #region Constants
        ...
        public AdminOrangeService(ICacheManager cacheManager) //,  IRepository<StorePickupPoint> storePickupPointRepository)
        {
