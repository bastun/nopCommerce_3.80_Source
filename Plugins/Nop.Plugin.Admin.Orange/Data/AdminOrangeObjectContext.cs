...
namespace Nop.Plugin.Admin.Orange.Data
{
    ...
    /// Object context
    /// </summary>
    public class AdminOrangeObjectContext : DbContext, IDbContext
    {
        #region Ctor

        public AdminOrangeObjectContext(string nameOrConnectionString) : base(nameOrConnectionString)
        {
        ...
        {
            modelBuilder.Configurations.Add(new AdminOrangeMap());
        ...
        {
            //drop the table
            this.DropPluginTable(this.GetTableName<AdminOrange>());
        }
